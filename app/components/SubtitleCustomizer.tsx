    ...
    <div className="bg-gray-900/90 backdrop-blur-sm rounded-lg border border-gray-700/50 p-4">
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <span className="text-sm text-gray-300">Line 1</span>
              <div className="flex gap-2">
                <button
                  onClick={() => setActiveColorPicker("line1-text")}
                  className="flex-1 h-8 rounded border border-gray-600 flex items-center justify-center gap-2"
            ...
            {/* Line 2 Colors */}
            <div className="space-y-2">
              <span className="text-sm text-gray-300">Line 2</span>
              <div className="flex gap-2">
                <button
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-medium text-gray-400">Font</h3>
          </div>
          <select
            value={subtitleFont}
            onChange={(e) => onFontChange(e.target.value as SubtitleFont)}
            className="w-full bg-gray-800 text-gray-300 text-sm rounded border border-gray-700 px-3 py-2"
          >
      ...
      {activeColorPicker && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          />
          <div className="relative bg-gray-900 p-4 rounded-lg shadow-xl">
            <ChromePicker
              color={
